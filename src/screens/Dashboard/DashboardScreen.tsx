/**
 * Dashboard Screen
 * Home screen showing today's sales, transactions, low stock alerts, and quick actions
 */
...
export default function DashboardScreen({ navigation }: any) {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      // Get all products and low stock items
        ...
        renderItem={() => (
          <View>
            ...
            <View className="mb-6">
              ...
              <Text className="text-base text-muted mt-1">{auth.shopName}</Text>
            </View>
